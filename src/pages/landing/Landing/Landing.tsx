...
const AgencyLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      <style>{`
      ...
      `}</style>
      <div className="relative border-b border-slate-200 dark:border-zinc-800">
        <div className="absolute inset-0 z-0 bg-white dark:bg-zinc-950 line hidden border-x border-x-(--pattern-fg) bg-[repeating-linear-gradient(315deg,var(--pattern-fg)_0,var(--pattern-fg)_1px,transparent_0,transparent_50%)] bg-size-[10px_10px] bg-fixed [--pattern-fg:var(--color-black)]/5 md:block dark:[--pattern-fg:var(--color-white)]/10" />
        <section className="relative z-10 flex flex-col items-center justify-center text-center px-4 pt-16 pb-24 md:pt-24 md:pb-32">
          <div className="max-w-4xl space-y-8 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-2xl shadow-slate-200/50 dark:shadow-none">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8 border-t border-slate-200 dark:border-zinc-800">
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="font-medium">{agency.teamSize}</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <Clock size={20} className="text-slate-400" />{" "}
                <span className="font-medium">{agency.timeZone}</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <Calendar size={20} className="text-slate-400" />{" "}
                <span className="font-medium">Est. {agency.founded}</span>
              </div>
            </div>
          </div>
        </section>
      </div>
      <div className="max-w-xl mx-auto border-l border-r bg-white">
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto border-t border-slate-200 dark:border-zinc-800">
      ...
      <section className="border-t border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 py-24 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4">
          <h1 className="text-7xl pl-3 font-bold tracking-tight mb-5">
            Leadership
          </h1>
