...
const CalculateWork = lazy(
  () => import("@/pages/dashboard/user/CalculateWork/CalculateWork"),
);
const UploadMaterial = lazy(
  () => import("@/pages/dashboard/user/UploadMaterial/Index"),
);
const CalculateWorkClient = lazy(
  () => import("@/pages/landing/CalculateWorkClient"),
);
const CalculateProducts = lazy(
  () => import("@/pages/landing/CalculateProducts"),
);
